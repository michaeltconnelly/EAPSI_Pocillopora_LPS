#!/bin/bash
#~/scripts/EAPSI.HW-WT-master/STARalign_SymC1.sh
#/scratch/projects/transcriptomics/mikeconnelly/scripts/EAPSI.HW-WT-master/STARalign_SymC1.sh
#purpose: align trimmed RNAseq reads against the Symbiodinium goreaui (C1) genome using STAR on the Pegasus bigmem queue

#BSUB -J staralign_symC1
#BSUB -q bigmem
#BSUB -P transcriptomics
#BSUB -o star_symC1%J.out
#BSUB -e star_symC1%J.err
#BSUB -n 8
#BSUB -W 6:00
...
--outFileNamePrefix ${coldir}/${exp}/STARalign_SymC1/${EAPSIsample}_SymC1
#lets me know file is done
echo "STAR alignment of $EAPSIsample complete"
done

#Call next scripts in analysis pipeline
bsub -P transcriptomics < /scratch/projects/transcriptomics/mikeconnelly/scripts/EAPSI.HW-WT-master/STARfC_SymC1.sh
