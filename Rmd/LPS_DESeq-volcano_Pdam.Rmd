...
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Volcano_LPS-ctrl.pdf", height = 3, width = 2.75)
...
```{r, warning = FALSE}
DEGcolors <- c("red", "blue", "dark grey")
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Volcano_LPS-ctrl_normal_labelled.pdf", height = 2.95, width = 4.25)
gVolcano_LPS_ctrl <- ggplot(data=dat_genes_LPS_ctrl, aes(log2FoldChange, log10padj))
...
```{r, warning = FALSE}
DEGcolors <- c("red", "blue", "dark grey")
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Volcano_LPS-ctrl_colonies.pdf", height = 2, width = 2.12)
