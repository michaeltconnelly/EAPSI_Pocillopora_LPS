...
```{r, include=FALSE}
      ...
      rld_LPS_int <- rlogTransformation(dds_LPS_int, blind = TRUE)
      ###
...
```{r}
pdf(file = "./outputs/DEseq-results/figures/PCAs_int.pdf", height = 4, width = 4.25)
ggPCA(rld_LPS_int, stable_samples_LPS, pclab = c(1,2))
ggPCA(rld_LPS_int, stable_samples_LPS, pclab = c(1,3))
ggPCA(rld_LPS_int, stable_samples_LPS, pclab = c(1,4))
ggPCA(rld_LPS_int, stable_samples_LPS, pclab = c(2,3))
ggPCA(rld_LPS_int, stable_samples_LPS, pclab = c(2,4))
ggPCA(rld_LPS_int, stable_samples_LPS, pclab = c(3,4))
```
