...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/PCAs.pdf", height = 4, width = 4.25)
...
```
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/PCAs_geno.pdf", width = 6.5, height = 4)
...
```
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/PCAs_trmt.pdf", width = 11, height = 8.5)
...
```
```{r, message=FALSE}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/PCAs_colonies.pdf", height = 2, width = 2.12)
...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/PCA_ProcB.pdf", height = 3, width = 3.75)
