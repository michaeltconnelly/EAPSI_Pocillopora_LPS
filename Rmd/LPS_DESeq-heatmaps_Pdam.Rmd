...
## 20 Gene Heatmap
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_top20.pdf", width = 6.5, height = 4)
...
## 50 Gene Heatmap
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_top50.pdf", width = 11, height = 8.5)
...
## 500 Gene Heatmap
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_top500.pdf", width = 8, height = 4)
...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_upDEG.pdf", width = 16, height = 16)
...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_dnDEG.pdf", width = 16, height = 14)
...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_allDEG_4.pdf", width = 8.5, height = 3.5)
...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_PC1load.pdf", width = 11, height = 8.5)
...
```
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_HW1_upDEG.pdf", width = 16, height = 16)
...
```
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_HW2_upDEG.pdf", width = 16, height = 16)
...
```
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_WT1_upDEG.pdf", width = 16, height = 16)
...
```
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_WT2_upDEG.pdf", width = 16, height = 16)
...
```{r geneheatmap, message = FALSE, warning = FALSE}
#Create heatmap matrix and annotation groupings
selectDEGs <- read.delim("~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/selectDEGs.txt", header = FALSE)
...
```
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/selectDEGs.pdf", width = 13.5, height = 6)
...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_allDEG_colonies.pdf", width = 2.12, height = 2)
...
```{r}
pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_consensusDEGs_1.pdf", width = 6.5, height = 2)
...
```
```{r}
#pdf(file = "~/computing/scripts/EAPSI_LPS-master/DESeqresults_Pdam/figures/Heatmap_consensusDEGs_2.pdf", width = 8.5, height = 3)
